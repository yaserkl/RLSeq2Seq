...
# Option 2: Process dataset using our helper code
...
## 2. Download article, headline, and highlights from raw data
...
1- Use [Spacy]() to tokenize and process the articles and its highlights.
